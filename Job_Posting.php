...
  <label for="CompanyID">Company ID:</label>
  ...
  <input type="text" id="Posting_date" name="Posting_date" ><br><br>
  
  <label for="Open_Date">Open Date:</label>
  <input type="text" id="Open_Date" name="Open_Date" ><br><br>
  
  <label for="Close_Date">Close_Date:</label>
  <input type="text" id="Close_date" name="Close_date" ><br><br>
...
  <label for="Postby">Postby:</label>
  <input type="text" id="Postby" name="Postby" ><br><br>  
